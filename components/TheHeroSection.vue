...
<template>
      ...
      >
        <div class="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
          ...
          <p class="mt-6 text-lg leading-8 text-gray-600">
            A global interactive map with layers to visualize and analyze
            complex interactions between environmental and societal factors.
          </p>
          ...
          >
            ...
            <defs>
              <clipPath id="2ade4387-9c63-4fc4-b754-10e687a0d332">
                <rect width="316" height="416" rx="36" />
              </clipPath>
            </defs>
            <!-- <path
              fill="#4B5563"
  ...
  <!--           <path
            ...
            >
              <img
                src="/pages/images/Space_Aurora_ESA321897cut.jpg"
                alt=""
              />
            </foreignObject>
          </svg>
